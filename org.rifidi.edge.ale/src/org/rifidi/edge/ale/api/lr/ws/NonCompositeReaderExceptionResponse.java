...
public class NonCompositeReaderExceptionResponse extends Exception {
    ...
    private org.rifidi.edge.ale.api.lr.ws.NonCompositeReaderException nonCompositeReaderException;
    ...
    public NonCompositeReaderExceptionResponse(String message, org.rifidi.edge.ale.api.lr.ws.NonCompositeReaderException nonCompositeReaderException) {
        super(message);
        this.nonCompositeReaderException = nonCompositeReaderException;
    }

    public NonCompositeReaderExceptionResponse(String message, org.rifidi.edge.ale.api.lr.ws.NonCompositeReaderException nonCompositeReaderException, Throwable cause) {
        super(message, cause);
        this.nonCompositeReaderException = nonCompositeReaderException;
    }

    public org.rifidi.edge.ale.api.lr.ws.NonCompositeReaderException getFaultInfo() {
