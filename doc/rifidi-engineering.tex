...
\end{figure}
 ...
 \subsubsection{Edge Server Configuration}
...
\begin{figure}
\resizebox{\textwidth}{!}{\includegraphics{eclipse10.png}}
\caption{\label{fig:eclipse10} Setting the Target Platform}
\end{figure}

\begin{figure}
\resizebox{\textwidth}{!}{\includegraphics{eclipse11.png}}
\caption{\label{fig:eclipse11} Run Configurations}
\end{figure}

\begin{figure}
\resizebox{\textwidth}{!}{\includegraphics{eclipse12.png}}
\caption{\label{fig:eclipse12} Default Edge Server Run Configuration}
\end{figure}

\begin{figure}
\resizebox{\textwidth}{!}{\includegraphics{eclipse13.png}}
...
\section{Edge-Server Applications}
