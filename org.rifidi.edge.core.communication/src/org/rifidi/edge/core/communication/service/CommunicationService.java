...
public interface CommunicationService {
	...
	/**
	 * This method takes the required information and connects to the reader and returns
	 * an asynchronous buffer for the plugin to use.
	 * @param plugin The Plugin itself
	 * @param info Plugin specific information about the reader.
	 * @param protocol Plugin specific protocol implementation.
	 * @return A communication buffer object.
	 * @throws UnknownHostException
	 * @throws ConnectException
	 * @throws IOException
	 * @throws NullPointerException Throws this if plugin, info, or protocol are null.
	 */
	 ...
	 * @throws IOException
	 */
	public void destroyConnection(CommunicationBuffer buffer)
			throws IOException;
}
