...
public class DummyReaderServer2 {
	...
	public static void main(String[] args) throws Exception {
		if (args.length == 2) {
			DummyReaderServer2 drs = new DummyReaderServer2(Integer
		...
		MessageLog ml = (MessageLog) unmarshaller.unmarshal(Resource
				.getResource(DummyReaderServer2.class, "taglog.xml"));
		tags = ml.log;
