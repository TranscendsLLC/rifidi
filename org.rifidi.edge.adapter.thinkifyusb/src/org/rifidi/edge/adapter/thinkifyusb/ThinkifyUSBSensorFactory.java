 ...
 */
public class ThinkifyUSBSensorFactory extends
		AbstractSensorFactory<ThinkifyUSBSensor> {

	/** A JMS event notification sender */
	private volatile NotifierService notifierService;

	/** The ID for this factory */
	public static final String FACTORY_ID = ThinkifyUSBConstants.FACTORY_ID;
	...
	public void createInstance(String serviceID)
		...
		ThinkifyUSBSensor instance = new ThinkifyUSBSensor(commands);
	...
	public MBeanInfo getServiceDescription(String factoryID) {
		return (MBeanInfo) ThinkifyUSBSensor.mbeaninfo.clone();
	}
