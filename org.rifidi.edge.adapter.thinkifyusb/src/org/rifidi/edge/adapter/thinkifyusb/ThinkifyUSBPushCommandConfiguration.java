 ...
 */
@JMXMBean
public class ThinkifyUSBPushCommandConfiguration extends
		AbstractCommandConfiguration<ThinkifyUSPushCommand> {
	 ...
	 */
	@Override
	public ThinkifyUSPushCommand getCommand(String readerID) {
		ThinkifyUSPushCommand command = new ThinkifyUSPushCommand(super.getID());
		return command;
	}
