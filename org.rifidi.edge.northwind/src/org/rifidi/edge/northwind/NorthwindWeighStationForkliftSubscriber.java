/*
 *  NorthwindWeighStationForkliftSubscriber.java
 *
 *  Created:	Aug 19, 2010
...
public class NorthwindWeighStationForkliftSubscriber extends
	 ...
	 * 
	 */
	public NorthwindWeighStationForkliftSubscriber(String forklift_prefix) {
	...
	public void stableSetReached(Set<TagReadEvent> stableSet) {
		this.checkForForklift(stableSet, forklift_prefix, WEIGH_STATION);
	}
}
