 ...
 *
 */
@CommandDesc(name = "ReaderVersion", groups = {"general"})
public class ReaderVersion implements Command {
	private static final Log logger = LogFactory
	.getLog(ReaderVersion.class);

	static private String command = "ReaderVersion";
