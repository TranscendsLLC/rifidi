 ...
 *
 */
@Widgets(name = "RFModulation", widgets = { 
		@Widget(type = WidgetType.INTEGER, elementName = "RFModulation", editable = true, defaultValue = "0", displayName = "RF Modulation") })
public class RFModulation implements Command {
	private static final Log logger = LogFactory
	.getLog(RFModulation.class);

	static private String command = "RFModulation";
