package org.rifidi.edge.readerplugin.alien.commands.time;
 ...
 *
 */
@CommandDesc(name = "TimeZone", groups = {"time"})
public class TimeZone implements Command {
	private static final Log logger = LogFactory
	.getLog(TimeZone.class);

	static private String command = "TimeZone";
