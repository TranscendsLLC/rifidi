...
@CommandDesc(name = "UpgradeAddress", groups = {"network"})
public class UpgradeAddress implements Command {
	private static final Log logger = LogFactory
			.getLog(UpgradeAddress.class);

	static private String command = "UpgradeAddress";
