 ...
 *
 */
@CommandDesc(name = "DHCPTimeout", groups = {"network"})
public class DHCPTimeout implements Command {
	private static final Log logger = LogFactory
			.getLog(DHCPTimeout.class);

	static private String command = "DHCPTimeout";
