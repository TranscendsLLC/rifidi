 ...
 *
 */
@CommandDesc(name = "FactorySettings", groups = {"general"})
public class FactorySettings implements Command {
	private static final Log logger = LogFactory
	.getLog(FactorySettings.class);

	static private String command = "FactorySettings";
