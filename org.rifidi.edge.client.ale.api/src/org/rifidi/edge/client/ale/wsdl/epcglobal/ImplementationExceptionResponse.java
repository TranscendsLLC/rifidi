...
public class ImplementationExceptionResponse extends Exception {
    ...
    private org.rifidi.edge.client.ale.wsdl.epcglobal.ImplementationException implementationException;
    ...
    public ImplementationExceptionResponse(String message, org.rifidi.edge.client.ale.wsdl.epcglobal.ImplementationException implementationException) {
        super(message);
        this.implementationException = implementationException;
    }

    public ImplementationExceptionResponse(String message, org.rifidi.edge.client.ale.wsdl.epcglobal.ImplementationException implementationException, Throwable cause) {
        super(message, cause);
        this.implementationException = implementationException;
    }

    public org.rifidi.edge.client.ale.wsdl.epcglobal.ImplementationException getFaultInfo() {
