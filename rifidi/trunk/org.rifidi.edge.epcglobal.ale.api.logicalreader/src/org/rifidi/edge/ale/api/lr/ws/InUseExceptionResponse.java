...
public class InUseExceptionResponse extends Exception {
    ...
    private org.rifidi.edge.ale.api.lr.ws.InUseException inUseException;
    ...
    public InUseExceptionResponse(String message, org.rifidi.edge.ale.api.lr.ws.InUseException inUseException) {
        super(message);
        this.inUseException = inUseException;
    }

    public InUseExceptionResponse(String message, org.rifidi.edge.ale.api.lr.ws.InUseException inUseException, Throwable cause) {
        super(message, cause);
        this.inUseException = inUseException;
    }

    public org.rifidi.edge.ale.api.lr.ws.InUseException getFaultInfo() {
