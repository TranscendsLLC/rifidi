...
public class SecurityExceptionResponse extends Exception {
    ...
    private org.rifidi.edge.ale.api.lr.ws.SecurityException securityException;
    ...
    public SecurityExceptionResponse(String message, org.rifidi.edge.ale.api.lr.ws.SecurityException securityException) {
        super(message);
        this.securityException = securityException;
    }

    public SecurityExceptionResponse(String message, org.rifidi.edge.ale.api.lr.ws.SecurityException securityException, Throwable cause) {
        super(message, cause);
        this.securityException = securityException;
    }

    public org.rifidi.edge.ale.api.lr.ws.SecurityException getFaultInfo() {
