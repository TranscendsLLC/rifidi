 ...
 *******************************************************************************/
package org.rifidi.app.dynamicreader;
 ...
 * 
 */
public class DynamicReaderApp extends AbstractRifidiApp {
	...
	public DynamicReaderApp(String group, String name) {
		super(group, name);
	}
	...
	public void initialize() {
		DynamicReaderSubscriber sub = new DynamicReaderSubscriber();
