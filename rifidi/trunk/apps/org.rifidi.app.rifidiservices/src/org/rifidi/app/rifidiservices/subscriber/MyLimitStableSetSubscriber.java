 ...
 */
public class MyLimitStableSetSubscriber 
		implements LimitStableSetSubscriber {
	...
	private String topicName = "myTopicLimitStableSet";
	 ...
	 */
	public MyLimitStableSetSubscriber(RifidiServicesApp rifidiServicesApp, ReadZone readZone) {
	...
	public void stableSetReached(Set<TagReadEvent> tagReadEventSet) {
		...
		rifidiServicesApp.unsubscribeFromLimitStableSetService(this);
		...
		*/
		...
		// Subscribe
		rifidiServicesApp.subscribeToLimitStableSetService(readZone);
