...
/**
 * 
 * This command gets the annotations for the commands of a plugin
 * 
 * @author Kyle Neumeier - kyle@pramari.com
 * 
 */
public class RPGetCommandAnnotationsCall
		extends
	 ...
	 *            plugin
	 */
	public RPGetCommandAnnotationsCall(ServerDescription serverDescription,
	...
	protected FormAnnotationListWrapper performRemoteCall(Remote remoteObject)
		...
		try {
			String xml = ((ReaderPluginManagerStub) remoteObject)
					.getCommandAnnotations(readerInfoClassName);
