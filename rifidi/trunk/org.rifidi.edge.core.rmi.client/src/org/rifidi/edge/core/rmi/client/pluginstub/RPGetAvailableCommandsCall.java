...
/**
 * This command object gets a list of the available commands and which groups
 * they are a member of
 * 
 * @author Kyle Neumeier - kyle@pramari.com
 * 
 */
public class RPGetAvailableCommandsCall
		extends
	...
	/**
	 * This command object gets a list of the available commands and which
	 ...
	 *            plugin
	 */
	public RPGetAvailableCommandsCall(ServerDescription serverDescription,
	...
	protected List<CommandGroupMap> performRemoteCall(Remote remoteObject)
		...
		return stub.getAvaliableCommands(readerInfoClassName);
	}
