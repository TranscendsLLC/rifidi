...
public class DuplicateNameExceptionResponse extends Exception {
    ...
    private org.rifidi.edge.ale.api.lr.ws.DuplicateNameException duplicateNameException;
    ...
    public DuplicateNameExceptionResponse(String message, org.rifidi.edge.ale.api.lr.ws.DuplicateNameException duplicateNameException) {
        super(message);
        this.duplicateNameException = duplicateNameException;
    }

    public DuplicateNameExceptionResponse(String message, org.rifidi.edge.ale.api.lr.ws.DuplicateNameException duplicateNameException, Throwable cause) {
        super(message, cause);
        this.duplicateNameException = duplicateNameException;
    }

    public org.rifidi.edge.ale.api.lr.ws.DuplicateNameException getFaultInfo() {
