...
public class ResetReaderHandler extends AbstractHandler implements IHandler {
	// private Log logger = LogFactory.getLog(ResetReaderHandler.class);
