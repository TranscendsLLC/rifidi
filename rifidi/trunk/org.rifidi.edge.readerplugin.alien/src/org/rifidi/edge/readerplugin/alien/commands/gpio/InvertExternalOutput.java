...
@CommandDesc(name = "InvertExternalOutput", groups = {"gpio"})
public class InvertExternalOutput implements Command {
	private static final Log logger = LogFactory
			.getLog(InvertExternalOutput.class);

	static private String command = "InvertExternalOutput";
