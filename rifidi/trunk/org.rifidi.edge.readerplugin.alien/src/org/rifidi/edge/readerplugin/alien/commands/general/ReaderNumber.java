 ...
 *
 */
@CommandDesc(name = "ReaderName", groups = {"general"})
public class ReaderNumber implements Command {
	private static final Log logger = LogFactory
	.getLog(ReaderNumber.class);

	static private String command = "ReaderName";
