...
public class DuplicateNameExceptionResponse extends Exception {
    ...
    private org.rifidi.edge.client.ale.api.wsdl.alelr.epcglobal.DuplicateNameException duplicateNameException;
    ...
    public DuplicateNameExceptionResponse(String message, org.rifidi.edge.client.ale.api.wsdl.alelr.epcglobal.DuplicateNameException duplicateNameException) {
        super(message);
        this.duplicateNameException = duplicateNameException;
    }

    public DuplicateNameExceptionResponse(String message, org.rifidi.edge.client.ale.api.wsdl.alelr.epcglobal.DuplicateNameException duplicateNameException, Throwable cause) {
        super(message, cause);
        this.duplicateNameException = duplicateNameException;
    }

    public org.rifidi.edge.client.ale.api.wsdl.alelr.epcglobal.DuplicateNameException getFaultInfo() {
