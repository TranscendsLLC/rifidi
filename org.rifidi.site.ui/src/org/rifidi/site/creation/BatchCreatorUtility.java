...
public class BatchCreatorUtility {
	 ...
	 * 
	 */
	private static final String SERVER_FOLDER = "../sites/";
	...
	/**
	 * 
	 * TODO: potential weirdness if the string contains special characters, be sure to only allow 
	 * alphanumeric from UI perspective.  
	 * 
	 * @param siteName
	 */
	public void createBatchFile(String siteName) {
		this.createFolders(siteName);
		File f = new File(SERVER_FOLDER + siteName + START_BAT + siteName
				+ END_BAT);
