...
public class ServerIntegrationSSLTest {
	...
	private static final Logger LOG = LoggerFactory
			.getLogger(ServerIntegrationSSLTest.class);
	...
	public void setUp() throws Exception {
		...
		//assertFalse(String.format("The DB storagefile %s already exists",
		//		Server.STORAGE_FILE_PATH), dbFile.exists());

		startServer();

		m_client = new MqttClient("ssl://localhost:1883", "TestClient",
				s_dataStore);
	...
	private SSLSocketFactory configureSSLSocketFactory()
		...
		InputStream jksInputStream = getClass().getClassLoader()
